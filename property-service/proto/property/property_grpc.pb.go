...
type PropertyServiceClient interface {
	CreateProperty(ctx context.Context, in *Property, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *propertyServiceClient) CreateProperty(ctx context.Context, in *Property, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type PropertyServiceServer interface {
	CreateProperty(context.Context, *Property) (*Response, error)
...
func (UnimplementedPropertyServiceServer) CreateProperty(context.Context, *Property) (*Response, error) {
